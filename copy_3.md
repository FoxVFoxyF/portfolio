...
<body>
    ...
    <div id="cyber-lightbox" class="cyber-lightbox">
        <div class="cyber-lightbox-content">
            ...
            <div class="cyber-lightbox-close" onclick="closeLightbox()">✕</div>
        </div>
    </div>
    ...
    <section id="section-2" class="relative">
        <button class="cyber-close-btn" onclick="closeExpandedContent()">✕</button>
    ...
    <!-- Floating kanji -->
    <div class="floating-kanji" style="left: 5%; animation-delay: 0s;">侍</div>
    <div class="floating-kanji" style="left: 15%; animation-delay: -5s;">忍</div>
    <div class="floating-kanji" style="left: 25%; animation-delay: -10s;">刀</div>
    <div class="floating-kanji" style="right: 5%; animation-delay: -2s;">龍</div>
    <div class="floating-kanji" style="right: 15%; animation-delay: -7s;">鬼</div>
...
const fallingChars = [
    // Kanji
    '侍', '忍', '刀', '龍', '鬼', '影', '電', '脳', '幻', '夢', '闇', '光',
    '剣', '火', '水', '風', '雷', '岩', '雪', '月', '星', '陽', '空', '海',
    '心', '魂', '神', '仏', '妖', '魔', '技', '術', '芸', '能', '力', '気',
                        ...
                        <ul class="space-y-2">
                            ${project.details.map(detail => `
                                <li class="flex items-start gap-2 text-gray-300">
                                    <span style="color: var(--color1);" class="mt-1">▸</span>
                                    ${detail}
                                </li>
                            `).join('')}
                        </ul>
